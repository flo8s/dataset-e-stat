{# 1kmメッシュ別の昼間人口推計。国勢調査(令和2年)と経済センサス(令和3年)の
   ...
   PAREA-Stat の原典である Sinfonica のリンクメッシュは「15歳以上非労働力人口 +
   未就学者 + 完全失業者 + 第1次産業就業者 − 15歳以上通学者 + 第2次・第3次産業
   従業者 + 生徒・学生数」という式を使うが、これは採れない。令和2年国勢調査は
   労働力状態「不詳」が激増しており (東京都で約296万人)、非労働力人口を積み上げる
   と残留人口が2割近く不足する。上の式は不詳のない夜間人口から引くので影響を
   受けない。
