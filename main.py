...
def main():
    ...
    logger.info("8/12: mesh_stats (1kmメッシュ統計)")
    ...
    logger.info("9/12: census_municipality (市区町村・都道府県別 基本集計)")
    ...
    logger.info("10/12: resident_registry (住民基本台帳 人口・世帯数・人口動態)")
    build_resident_registry("data/resident_registry", app_id)

    # 11. 経済センサス‐活動調査 産業横断的集計
    logger.info("11/12: economic_census (経済センサス 産業横断的集計)")
