...
def main():
    ...
    logger.info("8/10: mesh_stats (1kmメッシュ統計)")
    ...
    logger.info("9/10: census_municipality (市区町村・都道府県別 基本集計)")
