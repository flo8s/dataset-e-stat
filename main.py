...
def main():
    ...
    logger.info("8/11: mesh_stats (1kmメッシュ統計)")
    ...
    logger.info("10/11: resident_registry (住民基本台帳 人口・世帯数・人口動態)")
