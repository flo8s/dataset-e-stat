...
市区町村・都道府県の単位で、働いているかどうか（労働力状態）と、働き方（従業上の地位）を持つ2つのテーブルです。[市区町村別 基本集計](/cookbook/e_stat/census-municipality)が人口と世帯を扱うのに対し、こちらは就業の側面を扱います。地域を並べて労働力率や非正規雇用の割合を比べたいときに使います。
